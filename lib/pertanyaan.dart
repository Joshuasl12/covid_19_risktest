...
class _PertanyaanState extends State<Pertanyaan> {
    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              nomorSoal.toString() + ". " + pertanyaans[nomorSoal],
  ...
  void nextpertanyaan(BuildContext localContext) {
